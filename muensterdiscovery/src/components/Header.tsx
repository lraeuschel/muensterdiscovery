...
import { currentLanguage, setCurrentLanguage } from "./languageSelector";
...
export default function Header() {
    ...
    const [_,setCurrentLang] = useState<LanguageType>(currentLanguage);
    ...
    <Box data-lang={handleSetLanguage}></Box>
